                                    ...
                                    <div class="row">
                                        <form class="cmxform" id="signupForm" method="get" action="#">
                                            <fieldset class="row">
                                                ...
                                                <!--! GÉNEROS  -->
                                                <div class="mb-3 col-6">
                                                    <label for="gender_ids" class="form-label">
                                                        Géneros
                                                    </label>
                                                    <select class="js-example-basic-multiple form-select"
                                                        name="states[]" multiple="multiple">
                                                ...
                                                <div class="mb-3 col-6 container">
                                                    ...
                                                    <select class="js-example-basic-multiple form-select"
                                                        name="states[]" multiple="multiple">
                                                        <option value="1" data-select2-id="13">
                                                            ABASTO</option>
                                                        <option value="2" data-select2-id="14">
                                                            ACCESORIOS</option>
                                                        <option value="3" data-select2-id="15">
                                                            BORDADO</option>
                                                        <option value="4" data-select2-id="16">
                                                            CORTE</option>
                                                        <option value="5" data-select2-id="17">
                                                            CONFECCIÓN</option>
                                                        <option value="6" data-select2-id="18">
                                                            EMPAQUE</option>
                                                        <option value="7" data-select2-id="19">
                                                            ENTREGADO</option>
                                                        <option value="8" data-select2-id="20">
                                                            SERIGRAFIA</option>
                                                        <option value="9" data-select2-id="21">
                                                            SUBLIMADO</option>
                                                        <option value="10" data-select2-id="22">
                                                            TRAZOS</option>
                                                        <option value="11" data-select2-id="23">
                                                            AA</option>
                                                        <option value="12" data-select2-id="24">
                                                            AA</option>
                                                    </select>
                                                </div>
                                                <!--! Obs  -->
                                            ...
                                            <div class="form-group text-center">
                                                ...
                                                <button class="btn btn-warning btn-send mx-2" type="button" value=""
                                                    onclick="showSwal('editReg')">Toast
                                                </button>
                                            </div>
                                        </form>
                                    </div>
