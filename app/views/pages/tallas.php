                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="../pages/addTalla.php" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar Talla">
                                        <i class="mdi mdi-lead-pencil"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Activar Talla">
                                        <i class="mdi mdi-check-circle-outline"></i>
                                    </a>
                                    <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Inactivar Talla">
