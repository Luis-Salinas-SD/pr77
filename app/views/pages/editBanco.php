                                        ...
                                        <form class="cmxform" id="signupForm" method="get" action="#">
                                            <fieldset class="row">
                                                ...
                                                <div class="mb-3 col-12">
                                                    ...
                                                    <select class="form-select" id="exampleFormControlSelect1" name="opcion">
                                                ...
                                                <div class="mb-3 col-12">
                                                    <label for="exampleFormControlSelect1" class="form-label">
                                                        Valor inicial
                                                        <a href="#" class="text-black" data-bs-toggle="tooltip" data-bs-placement="top" title="Escribe solo números">
                                                            <i class="mdi mdi-help-circle-outline"></i>
                                                        </a>
                                                    </label>
